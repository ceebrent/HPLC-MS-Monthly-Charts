...
class LeveyJennings(object):
    def __init__(self):
        ...
        self.homeDirectory = r'\\192.168.0.242\profiles$\massspec\Desktop\MPX2 NEW PP VALIDATION'
    ...
    # Creates and returns folder to store results into
        def results_folder(self):
            ...
            machine_results = os.path.join(result_folder, 'Precision')
...
merge_txt_to_csv(r'\\192.168.0.242\profiles$\massspec\Desktop\MPX2 NEW PP VALIDATION\Data\Precision')
